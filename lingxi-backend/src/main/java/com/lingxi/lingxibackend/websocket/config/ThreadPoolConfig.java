...
import com.lingxi.lingxibackend.websocket.factory.MyThreadFactory;
...
public class ThreadPoolConfig implements AsyncConfigurer {
     ...
     * 项目共用线程池
     */
    public static final String LING_XI_CHAT_EXECUTOR = "lingxichatExecutor";
    /**
     * websocket通信线程池
     */
    ...
    public ThreadPoolTaskExecutor mallchatExecutor() {
        ...
        executor.setThreadNamePrefix("lingxichat-executor-");
